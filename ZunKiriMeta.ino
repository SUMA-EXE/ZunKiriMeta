...
//いいわよ！わたくしも　じかんをもてあましていたところよ
PROGMEM const uint8_t mesQAA2[] ={ 0xf0, 0x46,0x46,0x91,0x8a,0x09,0x91,0x61,0x51,0x59,0x84,0x00,0x5a,0x4d,0x95,0x94,0x84,0x68,0x44,0x80,0x59,0x68,0x46,0x61,0x6a,0x55,0x8f,0x8a, };
...
//では、そろそろはじめますね
PROGMEM const uint8_t mesQQ5[] ={ 0xf0, 0x69,0x71,0x01,0x5f,0x8f,0x5f,0x8f,0x71,0x5a,0x83,0x80,0x5b,0x6f, };
...
if (mode==0){//モード選択
  ...
  if (date_No==0){KAI=0;date_No=random(22)+1;}
  Word_No=date_No;
  //gosub *SARCH
  //Word_No=No3;
